...
module.exports.shawty = async(client, message, args) => {

  if (!message.member.hasPermission("ADMINISTRATOR") && !message.member.roles.cache.has(config.Yetkili.UstYT)) return;
...
module.exports.config = { 
    name: 'statsıfırla',
    aliases: ['statsıfırla', 'stat-sıfırla']
};